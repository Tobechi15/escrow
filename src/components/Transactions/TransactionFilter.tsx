      ...
      <div className="flex gap-4 flex-wrap">
        <div className="flex-1 min-w-[240px]">
          <div className="relative">
            ...
            <input type="text" placeholder="Search by ID or wallet address" className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
        <div className="flex gap-2">
          ...
          <button className="px-4 py-2 text-gray-600 rounded-lg hover:bg-gray-100">
            Active
          </button>
          <button className="px-4 py-2 text-gray-600 rounded-lg hover:bg-gray-100">
            Completed
